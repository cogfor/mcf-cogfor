/* $Id: OutboundDocument.java 988245 2010-08-23 18:39:35Z kwright $ */
...
public class OutboundDocument {
    ...
    private static InputStream compress(InputStream inputStream) throws IOException {
    ...
    public void loadString(String content) throws JSONException, ManifoldCFException, IOException {
...
//            this.document.setShareDenyACL(toArray(json.getJSONArray("acl_share_deny")));
    }
